...
# done: plot initial/ simple statistics => look at genes with a lot of CNVs, check where those genes are active

# done: look at samples with high numbers of outliers => do they have significantly higher CNVs compared to other samples?

# done (maybe): check effect of copy number on an outlier
...
def plot_cn_zscore(outlier_df, cnv_df, layer_name="mRNA"):
    ...
    sns.boxplot(data=merged, x='CN', y='zScore', hue='Type', palette='Set1')
